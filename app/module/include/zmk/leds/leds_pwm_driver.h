...
#define LED_COLOR_IDLE_MASK                                                                        \
    { 0, 0, 0 }
#define LED_COLOR_RED_MASK                                                                         \
    { 1, 0, 0 }
#define LED_COLOR_GREEN_MASK                                                                       \
    { 0, 1, 0 }
#define LED_COLOR_BLUE_MASK                                                                        \
    { 0, 0, 1 }
#define LED_COLOR_YELLOW_MASK                                                                      \
    { 1, 1, 0 }
#define LED_COLOR_CYAN_MASK                                                                        \
    { 0, 1, 1 }
#define LED_COLOR_PURPLR_MASK                                                                      \
    { 1, 0, 1 }
#define LED_COLOR_WHITE_MASK                                                                       \
    { 1, 1, 1 }
